...
void setup()
{
  ...
  ///////////////////////////////////////////////////////////////////////////////////////
  WiFiManagerParameter custom_token1_server("token1", "token1", token1, 40);
  ...
  wifiManager.addParameter(&custom_token1_server);
  wifiManager.addParameter(&custom_id_server);
  wifiManager.addParameter(&custom_ip_svr_server);
  ...
  strcpy(token1, custom_token1_server.getValue());
